...
if G.mot == '' :
    ...
    G.mot = chatGPT.question(f'donne moi un mot qui commence par {initiale_au_hasard} et qui contient {lettre_au_hasard}')
...
if G.nombredefautes > 1:
    st.write(f'vous avez fait {G.nombredefautes} fautes')
else:
    st.write(f'vous avez fait {G.nombredefautes} faute')
